...
. craft an Ansible command-line that uses the `raw` module to issue this command to the `ubuntu` group: `sudo apt-get --assume-yes install software-properties-common python`
...
== Lab 09: Our First Playbook
== Lab 10: Fun With Templates
