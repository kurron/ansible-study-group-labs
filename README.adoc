...
Groups can be created dynamically at runtime based on facts gathered at runtime, easing the burden of maintaining an inventory file.
...
. create two tasks that printout out a message specific to the group
