...
TIP: documentation on what modules return is usually very poor so get your debug tasks working to help figure exactly what to use from the result object.
