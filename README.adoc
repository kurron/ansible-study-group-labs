...
. run the playbook should result in the file copy and the reboot message appearing
...
CAUTION: Ansible has improved the handler mechanism.  When researching, we are using the legacy mechanism for this lab.
